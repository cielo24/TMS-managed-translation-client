...
class LanguagesApi(object):
    ...
    def languages_get_all_languages(self, **kwargs):  # noqa: E501
        """Get All Languages  # noqa: E501

        Gets all languages.  <br/>This list of languages is provided as a reference. It is common for developers to need to map language codes, and for that to happen one must know all the avaiable language codes from RWS.<br/>The presence of a language in this list does not mean that the language is available for use in translation projects. You must refer to the supported language pairs in the  for a list of available language pairs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.languages_get_all_languages(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.languages_get_all_languages_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.languages_get_all_languages_with_http_info(**kwargs)  # noqa: E501
            return data

    def languages_get_all_languages_with_http_info(self, **kwargs):  # noqa: E501
        """Get All Languages  # noqa: E501

        Gets all languages.  <br/>This list of languages is provided as a reference. It is common for developers to need to map language codes, and for that to happen one must know all the avaiable language codes from RWS.<br/>The presence of a language in this list does not mean that the language is available for use in translation projects. You must refer to the supported language pairs in the  for a list of available language pairs.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.languages_get_all_languages_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method languages_get_all_languages" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/tm4lc/api/v1/languages/list', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
