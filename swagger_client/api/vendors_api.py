...
class VendorsApi(object):
    ...
    def vendors_get_vendor(self, vendor_id, **kwargs):  # noqa: E501
        """Get Vendor  # noqa: E501

        Gets the vendor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vendors_get_vendor(vendor_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str vendor_id: The vendor identifier. (required)
        :return: PortalVendor
        ...
        if kwargs.get('async_req'):
            return self.vendors_get_vendor_with_http_info(vendor_id, **kwargs)  # noqa: E501
        else:
            (data) = self.vendors_get_vendor_with_http_info(vendor_id, **kwargs)  # noqa: E501
            return data

    def vendors_get_vendor_with_http_info(self, vendor_id, **kwargs):  # noqa: E501
        """Get Vendor  # noqa: E501

        Gets the vendor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vendors_get_vendor_with_http_info(vendor_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method vendors_get_vendor" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('vendor_id' not in params or
            ...
            raise ValueError("Missing the required parameter `vendor_id` when calling `vendors_get_vendor`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/tm4lc/api/v1/vendors/{vendorId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='PortalVendor',  # noqa: E501
    ...
    def vendors_get_vendors(self, **kwargs):  # noqa: E501
        """Get Vendors  # noqa: E501

        Gets the vendors for the current user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vendors_get_vendors(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: list[PortalVendor]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.vendors_get_vendors_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.vendors_get_vendors_with_http_info(**kwargs)  # noqa: E501
            return data

    def vendors_get_vendors_with_http_info(self, **kwargs):  # noqa: E501
        """Get Vendors  # noqa: E501

        Gets the vendors for the current user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.vendors_get_vendors_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method vendors_get_vendors" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[PortalVendor]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
