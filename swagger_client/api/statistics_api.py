...
class StatisticsApi(object):
    ...
    def statistics_get_statistics(self, duration, **kwargs):  # noqa: E501
        """Get Statistics  # noqa: E501

        Provides translation statistics for approved project created within the specified period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.statistics_get_statistics(duration, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str duration: The duration. 0 = LastThreeMonths, 1 = ThisMonth, 2 = ThisYear, 3 = LastTwelveMonths (required)
        :return: list[PortalDailyStatistic]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.statistics_get_statistics_with_http_info(duration, **kwargs)  # noqa: E501
        else:
            (data) = self.statistics_get_statistics_with_http_info(duration, **kwargs)  # noqa: E501
            return data

    def statistics_get_statistics_with_http_info(self, duration, **kwargs):  # noqa: E501
        """Get Statistics  # noqa: E501

        Provides translation statistics for approved project created within the specified period.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.statistics_get_statistics_with_http_info(duration, async_req=True)
        >>> result = thread.get()
        ...
        if ('duration' not in params or
            ...
            raise ValueError("Missing the required parameter `duration` when calling `statistics_get_statistics`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'duration' in params:
            path_params['duration'] = params['duration']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/tm4lc/api/v1/statistics/{duration}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='list[PortalDailyStatistic]',  # noqa: E501
