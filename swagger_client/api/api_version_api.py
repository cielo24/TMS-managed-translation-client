...
class ApiVersionApi(object):
    ...
    def api_version_get_api_build(self, **kwargs):  # noqa: E501
        """Get Api Build  # noqa: E501

        Gets the current build number for the application.  <br/>_This method does not require you to supply an authentication token._  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_version_get_api_build(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: dict(str, VersionReport)
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_version_get_api_build_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_version_get_api_build_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_version_get_api_build_with_http_info(self, **kwargs):  # noqa: E501
        """Get Api Build  # noqa: E501

        Gets the current build number for the application.  <br/>_This method does not require you to supply an authentication token._  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_version_get_api_build_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method api_version_get_api_build" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='dict(str, VersionReport)',  # noqa: E501
    ...
    def api_version_get_api_version(self, **kwargs):  # noqa: E501
        """Get Api Version  # noqa: E501

        Gets the highest supported API version for the application.  <br/>This api method allows you to interrogate the application to identify the highest supported API version. <br/>_This method does not require you to supply an authentication token._  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_version_get_api_version(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_version_get_api_version_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.api_version_get_api_version_with_http_info(**kwargs)  # noqa: E501
            return data

    def api_version_get_api_version_with_http_info(self, **kwargs):  # noqa: E501
        """Get Api Version  # noqa: E501

        Gets the highest supported API version for the application.  <br/>This api method allows you to interrogate the application to identify the highest supported API version. <br/>_This method does not require you to supply an authentication token._  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_version_get_api_version_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_version_get_api_version" % key
                )
            params[key] = val
        del params['kwargs']
