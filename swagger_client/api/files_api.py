...
class FilesApi(object):
    ...
    def files_add_reference_file(self, project_id, file, **kwargs):  # noqa: E501
        ...
        >>> thread = api.files_add_reference_file(project_id, file, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.files_add_reference_file_with_http_info(project_id, file, **kwargs)  # noqa: E501
        else:
            (data) = self.files_add_reference_file_with_http_info(project_id, file, **kwargs)  # noqa: E501
            return data

    def files_add_reference_file_with_http_info(self, project_id, file, **kwargs):  # noqa: E501
        """Add Reference File  # noqa: E501

        Add a reference file to an existing project.  <br/> If the content you provide is encoded using Base64 encoding, please supply an HTTP header named \" X-Base64-Content\" to indicate the provided content should be Base64 Decoded prior to processing. The value of the HTTP header should any of \"true\", \"yes\" or \"1\" to indicate that the content is Base64 encoded. Any other value, or the absence of the header, will result in the content being handled without first being Base64 decoded.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_add_reference_file_with_http_info(project_id, file, async_req=True)
        >>> result = thread.get()
    ...
    def files_get_files(self, file_id, **kwargs):  # noqa: E501
        """Get Files  # noqa: E501

        Gets information about previously uploaded files that have not yet been included in a translation project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_files(file_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str file_id: The project options identifier - if specified, the returned list of files will be             evaluated for suitability against the specified project creation options. (required)
        :return: list[LcFile]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.files_get_files_with_http_info(file_id, **kwargs)  # noqa: E501
        else:
            (data) = self.files_get_files_with_http_info(file_id, **kwargs)  # noqa: E501
            return data

    def files_get_files_with_http_info(self, file_id, **kwargs):  # noqa: E501
        """Get Files  # noqa: E501

        Gets information about previously uploaded files that have not yet been included in a translation project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_files_with_http_info(file_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('file_id' not in params or
                                                       params['file_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `file_id` when calling `files_get_files`")  # noqa: E501
    ...
    def files_get_studio_packages(self, project_ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_studio_packages(project_ids, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] project_ids: The project identifier as supplied by PortalProjectStatus.Id. (required)
        :return: file
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.files_get_studio_packages_with_http_info(project_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.files_get_studio_packages_with_http_info(project_ids, **kwargs)  # noqa: E501
            return data

    def files_get_studio_packages_with_http_info(self, project_ids, **kwargs):  # noqa: E501
        """Get Studio Packages  # noqa: E501

        Retrieves the studio packages for specified projects  <br/> This API method allows you to retrieve studio package file   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_studio_packages_with_http_info(project_ids, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('project_ids' not in params or
            ...
            raise ValueError("Missing the required parameter `project_ids` when calling `files_get_studio_packages`")  # noqa: E501
    ...
    def files_get_studio_packages_by_files(self, file_ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_studio_packages_by_files(file_ids, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[str] file_ids: A list of file identifiers (required)
        :return: file
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.files_get_studio_packages_by_files_with_http_info(file_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.files_get_studio_packages_by_files_with_http_info(file_ids, **kwargs)  # noqa: E501
            return data

    def files_get_studio_packages_by_files_with_http_info(self, file_ids, **kwargs):  # noqa: E501
        """Get Studio Packages By Files  # noqa: E501

        Retrieves the studio packages for specified files  <br/> This API method allows you to retrieve studio package file   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_get_studio_packages_by_files_with_http_info(file_ids, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('file_ids' not in params or
            ...
            raise ValueError("Missing the required parameter `file_ids` when calling `files_get_studio_packages_by_files`")  # noqa: E501
    ...
    def files_upload(self, file_id, file, **kwargs):  # noqa: E501
        """Upload  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_upload(file_id, file, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str file_id: The project options identifier against which the uploaded file will be evaluated. (required)
        :param file file: (required)
        :return: list[LcFile]
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.files_upload_with_http_info(file_id, file, **kwargs)  # noqa: E501
        else:
            (data) = self.files_upload_with_http_info(file_id, file, **kwargs)  # noqa: E501
            return data

    def files_upload_with_http_info(self, file_id, file, **kwargs):  # noqa: E501
        """Upload  # noqa: E501

        Allows uploads of files for translation or for inclusion in a translation project as reference material. Uploads must be             submitted using [multipart/form-data](https://www.w3.org/TR/html401/interact/forms.html#h-17.13.4.2) and can contain more             than one file, although this is rarely useful and increases the impact of any failure. The Uri requires you to specify             the ProjectOptionId that should be used to evaluate the uploaded file(s).             This is used to enable us to consider whether each file you upload is a possible candidate for translation or must be handled as             reference material. In the case of archives (zip, rar, 7z, tar files) we will examine the contents of the archive and indicate             whether the archive as a whole can be translated or not, or whether it contains a mixture of translatable and non-translatable files.  <br/> If the content you provide is encoded using Base64 encoding, please supply an HTTP header named \" X-Base64-Content\" to indicate that the provided content should be Base64 Decoded prior to processing. The value of the HTTP header should any of \"true\", \"yes\" or \"1\" to indicate that the content is Base64 encoded. Any other value, or the absence of the header, will result in the content being handled without first being Base64 decoded.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.files_upload_with_http_info(file_id, file, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['file_id', 'file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('file_id' not in params or
                                                       params['file_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `file_id` when calling `files_upload`")  # noqa: E501
        # verify the required parameter 'file' is set
        if self.api_client.client_side_validation and ('file' not in params or
                                                       params['file'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/tm4lc/api/v1/files/{fileId}', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
