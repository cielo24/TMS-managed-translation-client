...
class PortalTmOptions(object):
    ...
    def __init__(self, description=None, id=None, language_pairs=None, name=None, _configuration=None):  # noqa: E501
        """PortalTmOptions - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this PortalTmOptions.  # noqa: E501

        Gets or sets the description.  # noqa: E501

        :return: The description of this PortalTmOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PortalTmOptions.

        Gets or sets the description.  # noqa: E501

        :param description: The description of this PortalTmOptions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this PortalTmOptions.  # noqa: E501

        Gets or sets the identifier.  # noqa: E501

        :return: The id of this PortalTmOptions.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PortalTmOptions.

        Gets or sets the identifier.  # noqa: E501

        :param id: The id of this PortalTmOptions.  # noqa: E501
        :type: str
        """
    ...
    def language_pairs(self):
        """Gets the language_pairs of this PortalTmOptions.  # noqa: E501

        Gets or sets the language pairs.  # noqa: E501

        :return: The language_pairs of this PortalTmOptions.  # noqa: E501
    ...
    def language_pairs(self, language_pairs):
        """Sets the language_pairs of this PortalTmOptions.

        Gets or sets the language pairs.  # noqa: E501

        :param language_pairs: The language_pairs of this PortalTmOptions.  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PortalTmOptions.  # noqa: E501

        Gets or sets the name.  # noqa: E501

        :return: The name of this PortalTmOptions.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PortalTmOptions.

        Gets or sets the name.  # noqa: E501

        :param name: The name of this PortalTmOptions.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalTmOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalTmOptions):
            return False
