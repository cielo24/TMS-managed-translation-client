...
class PortalDailyStatistic(object):
    ...
    def __init__(self, costs=None, _date=None, language_pairs=None, leverage=None, overall_leverage=None, savings=None, total_files=None, total_projects=None, total_words=None, _configuration=None):  # noqa: E501
