...
class LcFile(object):
    ...
    def __init__(self, allow_all_file_extensions=None, archive_file_name_hashes=None, archive_is_password_protected=None, archive_is_unsupported=None, file_id=None, file_name=None, file_name_hash=None, has_unsupported_path_length=None, is_reference=None, is_translatable=None, provider_name=None, unsupported_are_reference=None, unsupported_files_in_archive=None, upload_complete=None, word_count=None):  # noqa: E501
