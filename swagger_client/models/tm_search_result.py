...
class TmSearchResult(object):
    ...
    def __init__(self, annotated_source_text=None, attributes=None, format=None, penalties=None, score=None, segment_id=None, source_text=None, target_text=None, tm_name=None, total_penalty=None, translation_id=None):  # noqa: E501
