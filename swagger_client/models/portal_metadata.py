...
class PortalMetadata(object):
    ...
    def __init__(self, control=None, default_value=None, description=None, id=None, is_read_only=None, is_required=None, language=None, maximum_length=None, max_option_length=None, min_option_length=None, name=None, options=None, total_options_count=None, type=None, value=None, watermark=None, _configuration=None):  # noqa: E501
