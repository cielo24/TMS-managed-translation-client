...
class PortalProjectParams(object):
    ...
    def __init__(self, description=None, due_date=None, files=None, metadata=None, name=None, project_group_id=None, project_options_id=None, scope_option_id=None, src_lang=None, tgt_langs=None, tm_sequence_id=None, vendors=None):  # noqa: E501
