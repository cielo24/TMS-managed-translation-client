...
class PortalLanguage(object):
    ...
    def __init__(self, code=None, culture_code=None, name=None, short_name=None, _configuration=None):  # noqa: E501
        """PortalLanguage - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this PortalLanguage.  # noqa: E501

        The platform specific language code for the language. e.g. FR (TMS) or fr_FR. This value is provided for reference             only. In most cases you could use CultureCode.  # noqa: E501

        :return: The code of this PortalLanguage.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this PortalLanguage.

        The platform specific language code for the language. e.g. FR (TMS) or fr_FR. This value is provided for reference             only. In most cases you could use CultureCode.  # noqa: E501

        :param code: The code of this PortalLanguage.  # noqa: E501
        :type: str
        """
    ...
    def culture_code(self):
        """Gets the culture_code of this PortalLanguage.  # noqa: E501

        The RFC 4646 name for the culture/language, based on ISO-639 and ISO-3166, and taken from the Microsoft .Net Framework.  # noqa: E501

        :return: The culture_code of this PortalLanguage.  # noqa: E501
        :rtype: str
        """
    ...
    def culture_code(self, culture_code):
        """Sets the culture_code of this PortalLanguage.

        The RFC 4646 name for the culture/language, based on ISO-639 and ISO-3166, and taken from the Microsoft .Net Framework.  # noqa: E501

        :param culture_code: The culture_code of this PortalLanguage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this PortalLanguage.  # noqa: E501

        The name of the language, e.g. English (United States)  # noqa: E501

        :return: The name of this PortalLanguage.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PortalLanguage.

        The name of the language, e.g. English (United States)  # noqa: E501

        :param name: The name of this PortalLanguage.  # noqa: E501
        :type: str
        """
    ...
    @property
    def short_name(self):
        """Gets the short_name of this PortalLanguage.  # noqa: E501

        The short name of the language, e.g. English  # noqa: E501

        :return: The short_name of this PortalLanguage.  # noqa: E501
        :rtype: str
        """
    ...
    def short_name(self, short_name):
        """Sets the short_name of this PortalLanguage.

        The short name of the language, e.g. English  # noqa: E501

        :param short_name: The short_name of this PortalLanguage.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalLanguage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalLanguage):
            return False
