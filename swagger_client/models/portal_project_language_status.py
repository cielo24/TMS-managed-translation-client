...
class PortalProjectLanguageStatus(object):
    ...
    def __init__(self, files=None, fuzzy_words=None, hundred_words=None, language=None, locked_words=None, new_words=None, percent_complete=None, perfect_match_words=None, repeated_words=None, tm_leverage=None, tm_savings=None, total_cost=None, total_words=None):  # noqa: E501
