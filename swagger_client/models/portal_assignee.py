...
class PortalAssignee(object):
    ...
    def __init__(self, assigned_user_display_name=None, assigned_user_email=None, assigned_user_id=None, assigned_user_name=None, _configuration=None):  # noqa: E501
        """PortalAssignee - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._assigned_user_display_name = None
        self._assigned_user_email = None
        self._assigned_user_id = None
        self._assigned_user_name = None
        self.discriminator = None

        if assigned_user_display_name is not None:
            self.assigned_user_display_name = assigned_user_display_name
    ...
    @property
    def assigned_user_display_name(self):
        """Gets the assigned_user_display_name of this PortalAssignee.  # noqa: E501

        Gets or sets the display name of the assigned user.  # noqa: E501

        :return: The assigned_user_display_name of this PortalAssignee.  # noqa: E501
        :rtype: str
        """
        return self._assigned_user_display_name

    @assigned_user_display_name.setter
    def assigned_user_display_name(self, assigned_user_display_name):
        """Sets the assigned_user_display_name of this PortalAssignee.

        Gets or sets the display name of the assigned user.  # noqa: E501

        :param assigned_user_display_name: The assigned_user_display_name of this PortalAssignee.  # noqa: E501
        :type: str
        """

        self._assigned_user_display_name = assigned_user_display_name

    @property
    def assigned_user_email(self):
        """Gets the assigned_user_email of this PortalAssignee.  # noqa: E501

        Gets or sets the assigned user email.  # noqa: E501

        :return: The assigned_user_email of this PortalAssignee.  # noqa: E501
        :rtype: str
        """
        return self._assigned_user_email

    @assigned_user_email.setter
    def assigned_user_email(self, assigned_user_email):
        """Sets the assigned_user_email of this PortalAssignee.

        Gets or sets the assigned user email.  # noqa: E501

        :param assigned_user_email: The assigned_user_email of this PortalAssignee.  # noqa: E501
        :type: str
        """

        self._assigned_user_email = assigned_user_email

    @property
    def assigned_user_id(self):
        """Gets the assigned_user_id of this PortalAssignee.  # noqa: E501

        Gets or sets the assigned user identifier.  # noqa: E501

        :return: The assigned_user_id of this PortalAssignee.  # noqa: E501
        :rtype: str
        """
    ...
    def assigned_user_id(self, assigned_user_id):
        """Sets the assigned_user_id of this PortalAssignee.

        Gets or sets the assigned user identifier.  # noqa: E501

        :param assigned_user_id: The assigned_user_id of this PortalAssignee.  # noqa: E501
        :type: str
        """
    ...
    def assigned_user_name(self):
        """Gets the assigned_user_name of this PortalAssignee.  # noqa: E501

        Gets or sets the assigned user name.  # noqa: E501

        :return: The assigned_user_name of this PortalAssignee.  # noqa: E501
        :rtype: str
        """
        return self._assigned_user_name

    @assigned_user_name.setter
    def assigned_user_name(self, assigned_user_name):
        """Sets the assigned_user_name of this PortalAssignee.

        Gets or sets the assigned user name.  # noqa: E501

        :param assigned_user_name: The assigned_user_name of this PortalAssignee.  # noqa: E501
        :type: str
        """

        self._assigned_user_name = assigned_user_name
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalAssignee, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalAssignee):
            return False
