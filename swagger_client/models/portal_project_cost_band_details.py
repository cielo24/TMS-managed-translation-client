...
class PortalProjectCostBandDetails(object):
    ...
    def __init__(self, _configuration=None):  # noqa: E501
        """PortalProjectCostBandDetails - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalProjectCostBandDetails, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalProjectCostBandDetails):
            return False
