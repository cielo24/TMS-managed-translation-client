...
class PortalWorkflowAttribute(object):
    ...
    def __init__(self, attribute_name=None, attribute_type=None, attribute_value=None, data_length=None, data_type=None, guid=None, id=None, workflow_name=None):  # noqa: E501
