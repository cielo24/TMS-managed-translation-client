...
class ProjectFile(object):
    ...
    def __init__(self, file_id=None, targets=None, _configuration=None):  # noqa: E501
    ...
    @property
    def file_id(self):
        """Gets the file_id of this ProjectFile.  # noqa: E501

        Gets or sets the id of the file.  # noqa: E501

        :return: The file_id of this ProjectFile.  # noqa: E501
        :rtype: str
        """
    ...
    def file_id(self, file_id):
        """Sets the file_id of this ProjectFile.

        Gets or sets the id of the file.  # noqa: E501

        :param file_id: The file_id of this ProjectFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def targets(self):
        """Gets the targets of this ProjectFile.  # noqa: E501

        Gets or sets the target language codes.             The value should be taken from PortalLanguage.CultureCode. If no languages are supplied, the file will be             attached to the project as a reference file.  # noqa: E501

        :return: The targets of this ProjectFile.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def targets(self, targets):
        """Sets the targets of this ProjectFile.

        Gets or sets the target language codes.             The value should be taken from PortalLanguage.CultureCode. If no languages are supplied, the file will be             attached to the project as a reference file.  # noqa: E501

        :param targets: The targets of this ProjectFile.  # noqa: E501
        :type: list[str]
        """
