...
class PortalUserProjectTemplate(object):
    ...
    def __init__(self, id=None, metadata=None, name=None, organization=None, project_group=None, project_option=None, source_language=None, target_languages=None, tm_sequence=None, vendors=None, _configuration=None):  # noqa: E501
