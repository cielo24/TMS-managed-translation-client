...
class PortalScopeOption(object):
    ...
    swagger_types = {
        ...
        'deleted': 'bool',
        'disabled': 'bool',
        'lc_meta_data': 'list[KeyValuePair]',
        'location': 'str',
        'scope_id': 'str',
        'scope_name': 'str',
    ...
    def __init__(self, can_create_projects=None, default_scope_option=None, deleted=None, disabled=None, lc_meta_data=None, location=None, scope_id=None, scope_name=None, scope_options=None, _configuration=None):  # noqa: E501
