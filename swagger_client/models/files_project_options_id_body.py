...
class FilesProjectOptionsIdBody(object):
    ...
    def __init__(self, file=None):  # noqa: E501
        """FilesProjectOptionsIdBody - a model defined in Swagger"""  # noqa: E501
        self._file = None
    ...
    @property
    def file(self):
        """Gets the file of this FilesProjectOptionsIdBody.  # noqa: E501


        :return: The file of this FilesProjectOptionsIdBody.  # noqa: E501
        :rtype: str
        """
        return self._file
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this FilesProjectOptionsIdBody.


        :param file: The file of this FilesProjectOptionsIdBody.  # noqa: E501
        :type: str
        """
        if file is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FilesProjectOptionsIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FilesProjectOptionsIdBody):
            return False
