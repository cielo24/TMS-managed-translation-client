...
class PortalReviewer(object):
    ...
    attribute_map = {
        ...
        'review_ended': 'ReviewEnded',
        'reviewer': 'Reviewer',
        'review_started': 'ReviewStarted'
    }

    def __init__(self, review_deadline=None, review_ended=None, reviewer=None, review_started=None, _configuration=None):  # noqa: E501
        """PortalReviewer - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._review_deadline = None
        self._review_ended = None
        self._reviewer = None
        self._review_started = None
        self.discriminator = None

        if review_deadline is not None:
            self.review_deadline = review_deadline
        if review_ended is not None:
            self.review_ended = review_ended
        if reviewer is not None:
            self.reviewer = reviewer
        if review_started is not None:
            self.review_started = review_started

    @property
    def review_deadline(self):
        """Gets the review_deadline of this PortalReviewer.  # noqa: E501

        Gets or sets the review deadline (as ticks).  # noqa: E501

        :return: The review_deadline of this PortalReviewer.  # noqa: E501
        :rtype: datetime
        """
        return self._review_deadline

    @review_deadline.setter
    def review_deadline(self, review_deadline):
        """Sets the review_deadline of this PortalReviewer.

        Gets or sets the review deadline (as ticks).  # noqa: E501

        :param review_deadline: The review_deadline of this PortalReviewer.  # noqa: E501
        :type: datetime
        """

        self._review_deadline = review_deadline

    @property
    def review_ended(self):
        """Gets the review_ended of this PortalReviewer.  # noqa: E501

        Gets or sets the review end (as ticks).  # noqa: E501

        :return: The review_ended of this PortalReviewer.  # noqa: E501
        :rtype: datetime
        """
        return self._review_ended

    @review_ended.setter
    def review_ended(self, review_ended):
        """Sets the review_ended of this PortalReviewer.

        Gets or sets the review end (as ticks).  # noqa: E501

        :param review_ended: The review_ended of this PortalReviewer.  # noqa: E501
        :type: datetime
        """

        self._review_ended = review_ended

    @property
    def reviewer(self):
        """Gets the reviewer of this PortalReviewer.  # noqa: E501

        Gets or sets the reviewer.  # noqa: E501

        :return: The reviewer of this PortalReviewer.  # noqa: E501
        :rtype: str
        """
    ...
    def reviewer(self, reviewer):
        """Sets the reviewer of this PortalReviewer.

        Gets or sets the reviewer.  # noqa: E501

        :param reviewer: The reviewer of this PortalReviewer.  # noqa: E501
        :type: str
        """
    ...
    def review_started(self):
        """Gets the review_started of this PortalReviewer.  # noqa: E501

        Gets or sets the review start (as ticks).  # noqa: E501

        :return: The review_started of this PortalReviewer.  # noqa: E501
        :rtype: datetime
        """
        return self._review_started

    @review_started.setter
    def review_started(self, review_started):
        """Sets the review_started of this PortalReviewer.

        Gets or sets the review start (as ticks).  # noqa: E501

        :param review_started: The review_started of this PortalReviewer.  # noqa: E501
        :type: datetime
        """

        self._review_started = review_started
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalReviewer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalReviewer):
            return False
