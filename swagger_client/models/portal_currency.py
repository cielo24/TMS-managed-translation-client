...
class PortalCurrency(object):
    ...
    def __init__(self, code=None, symbol=None, _configuration=None):  # noqa: E501
        """PortalCurrency - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this PortalCurrency.  # noqa: E501

        The ISO 4217 code associated with the currency, e.g. USD, GBP, EUR  # noqa: E501

        :return: The code of this PortalCurrency.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this PortalCurrency.

        The ISO 4217 code associated with the currency, e.g. USD, GBP, EUR  # noqa: E501

        :param code: The code of this PortalCurrency.  # noqa: E501
        :type: str
        """
    ...
    @property
    def symbol(self):
        """Gets the symbol of this PortalCurrency.  # noqa: E501

        The symbol associated with the currency, e.g. $, £, €  # noqa: E501

        :return: The symbol of this PortalCurrency.  # noqa: E501
        :rtype: str
        """
        return self._symbol
    ...
    def symbol(self, symbol):
        """Sets the symbol of this PortalCurrency.

        The symbol associated with the currency, e.g. $, £, €  # noqa: E501

        :param symbol: The symbol of this PortalCurrency.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalCurrency, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalCurrency):
            return False
