...
class PortalCostAttribute(object):
    ...
    def __init__(self, attribute_name=None, attribute_type=None, attribute_value=None, cost_matrix_name=None, data_length=None, data_type=None, guid=None, id=None, _configuration=None):  # noqa: E501
