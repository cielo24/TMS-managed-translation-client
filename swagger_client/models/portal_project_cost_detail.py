...
class PortalProjectCostDetail(object):
    ...
    swagger_types = {
        'comment': 'str',
        'cost_band_details': 'list[PortalProjectCostBandDetails]',
        'description': 'str',
        'is_promo_disc': 'bool',
    ...
    attribute_map = {
        'comment': 'Comment',
        'cost_band_details': 'CostBandDetails',
        'description': 'Description',
        'is_promo_disc': 'IsPromoDisc',
        'language': 'Language',
        'name': 'Name',
        'value': 'Value'
    }

    def __init__(self, comment=None, cost_band_details=None, description=None, is_promo_disc=None, language=None, name=None, value=None, _configuration=None):  # noqa: E501
        """PortalProjectCostDetail - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._comment = None
        self._cost_band_details = None
        self._description = None
        self._is_promo_disc = None
        self._language = None
        self._name = None
        self._value = None
        ...
        if cost_band_details is not None:
            self.cost_band_details = cost_band_details
        if description is not None:
            self.description = description
        if is_promo_disc is not None:
            self.is_promo_disc = is_promo_disc
    ...
    @property
    def comment(self):
        """Gets the comment of this PortalProjectCostDetail.  # noqa: E501

        The comment associated with the cost detail entry.  # noqa: E501

        :return: The comment of this PortalProjectCostDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def comment(self, comment):
        """Sets the comment of this PortalProjectCostDetail.

        The comment associated with the cost detail entry.  # noqa: E501

        :param comment: The comment of this PortalProjectCostDetail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cost_band_details(self):
        """Gets the cost_band_details of this PortalProjectCostDetail.  # noqa: E501

        Internal details of the cost  # noqa: E501

        :return: The cost_band_details of this PortalProjectCostDetail.  # noqa: E501
        :rtype: list[PortalProjectCostBandDetails]
        """
        return self._cost_band_details

    @cost_band_details.setter
    def cost_band_details(self, cost_band_details):
        """Sets the cost_band_details of this PortalProjectCostDetail.

        Internal details of the cost  # noqa: E501

        :param cost_band_details: The cost_band_details of this PortalProjectCostDetail.  # noqa: E501
        :type: list[PortalProjectCostBandDetails]
        """

        self._cost_band_details = cost_band_details

    @property
    def description(self):
        """Gets the description of this PortalProjectCostDetail.  # noqa: E501

        The description of the cost  # noqa: E501

        :return: The description of this PortalProjectCostDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PortalProjectCostDetail.

        The description of the cost  # noqa: E501

        :param description: The description of this PortalProjectCostDetail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def is_promo_disc(self):
        """Gets the is_promo_disc of this PortalProjectCostDetail.  # noqa: E501

        A value indicating whether the value associated with the cost detail entry is a promotional discount.  # noqa: E501

        :return: The is_promo_disc of this PortalProjectCostDetail.  # noqa: E501
        :rtype: bool
        """
        return self._is_promo_disc

    @is_promo_disc.setter
    def is_promo_disc(self, is_promo_disc):
        """Sets the is_promo_disc of this PortalProjectCostDetail.

        A value indicating whether the value associated with the cost detail entry is a promotional discount.  # noqa: E501

        :param is_promo_disc: The is_promo_disc of this PortalProjectCostDetail.  # noqa: E501
        :type: bool
        """

        self._is_promo_disc = is_promo_disc

    @property
    def language(self):
        """Gets the language of this PortalProjectCostDetail.  # noqa: E501

        The language associated with the cost detail entry.  # noqa: E501

        :return: The language of this PortalProjectCostDetail.  # noqa: E501
    ...
    def language(self, language):
        """Sets the language of this PortalProjectCostDetail.

        The language associated with the cost detail entry.  # noqa: E501

        :param language: The language of this PortalProjectCostDetail.  # noqa: E501
        :type: PortalLanguage
        """
    ...
    @property
    def name(self):
        """Gets the name of this PortalProjectCostDetail.  # noqa: E501

        The name of the cost detail entry, e.g. Project Management  # noqa: E501

        :return: The name of this PortalProjectCostDetail.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PortalProjectCostDetail.

        The name of the cost detail entry, e.g. Project Management  # noqa: E501

        :param name: The name of this PortalProjectCostDetail.  # noqa: E501
        :type: str
        """
    ...
    @property
    def value(self):
        """Gets the value of this PortalProjectCostDetail.  # noqa: E501

        The value associated with the cost detail entry.  # noqa: E501

        :return: The value of this PortalProjectCostDetail.  # noqa: E501
        :rtype: float
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this PortalProjectCostDetail.

        The value associated with the cost detail entry.  # noqa: E501

        :param value: The value of this PortalProjectCostDetail.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalProjectCostDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalProjectCostDetail):
            return False
