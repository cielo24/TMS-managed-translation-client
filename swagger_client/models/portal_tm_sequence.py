...
class PortalTmSequence(object):
    ...
    def __init__(self, description=None, id=None, name=None, _configuration=None):  # noqa: E501
        """PortalTmSequence - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this PortalTmSequence.  # noqa: E501

        Gets or sets the description.  # noqa: E501

        :return: The description of this PortalTmSequence.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PortalTmSequence.

        Gets or sets the description.  # noqa: E501

        :param description: The description of this PortalTmSequence.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this PortalTmSequence.  # noqa: E501

        Gets or sets the identifier.  # noqa: E501

        :return: The id of this PortalTmSequence.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PortalTmSequence.

        Gets or sets the identifier.  # noqa: E501

        :param id: The id of this PortalTmSequence.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this PortalTmSequence.  # noqa: E501

        Gets or sets the name.  # noqa: E501

        :return: The name of this PortalTmSequence.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PortalTmSequence.

        Gets or sets the name.  # noqa: E501

        :param name: The name of this PortalTmSequence.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PortalTmSequence, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortalTmSequence):
            return False
