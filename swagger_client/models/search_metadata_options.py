...
class SearchMetadataOptions(object):
    ...
    def __init__(self, options=None, total_matches_count=None, _configuration=None):  # noqa: E501
        """SearchMetadataOptions - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._options = None
        self._total_matches_count = None
        self.discriminator = None

        if options is not None:
            self.options = options
        if total_matches_count is not None:
            self.total_matches_count = total_matches_count

    @property
    def options(self):
        """Gets the options of this SearchMetadataOptions.  # noqa: E501

        Options  # noqa: E501

        :return: The options of this SearchMetadataOptions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def options(self, options):
        """Sets the options of this SearchMetadataOptions.

        Options  # noqa: E501

        :param options: The options of this SearchMetadataOptions.  # noqa: E501
        :type: list[str]
        """
    ...
    def total_matches_count(self):
        """Gets the total_matches_count of this SearchMetadataOptions.  # noqa: E501

        Number of total matching records  # noqa: E501

        :return: The total_matches_count of this SearchMetadataOptions.  # noqa: E501
        :rtype: int
        """
        return self._total_matches_count

    @total_matches_count.setter
    def total_matches_count(self, total_matches_count):
        """Sets the total_matches_count of this SearchMetadataOptions.

        Number of total matching records  # noqa: E501

        :param total_matches_count: The total_matches_count of this SearchMetadataOptions.  # noqa: E501
        :type: int
        """

        self._total_matches_count = total_matches_count
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SearchMetadataOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchMetadataOptions):
            return False
