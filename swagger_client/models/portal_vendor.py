...
class PortalVendor(object):
    ...
    def __init__(self, address=None, assignees=None, assignees_language_pair=None, description=None, id=None, key_contact_email=None, key_contact_name=None, language_pairs=None, metadata=None, name=None, on_time_deliveries=None, quality_rating=None, telephone=None):  # noqa: E501
