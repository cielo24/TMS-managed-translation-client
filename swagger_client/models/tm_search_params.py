...
class TmSearchParams(object):
    ...
    def __init__(self, format=None, maximum_matches=None, minimum_match_percentage=None, partial_search=None, segments=None, source_language=None, target_language=None):  # noqa: E501
