...
class TokenErrorResponse(object):
    ...
    def __init__(self, error=None, error_description=None, _configuration=None):  # noqa: E501
        """TokenErrorResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def error(self):
        """Gets the error of this TokenErrorResponse.  # noqa: E501

        Gets the error.  # noqa: E501

        :return: The error of this TokenErrorResponse.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this TokenErrorResponse.

        Gets the error.  # noqa: E501

        :param error: The error of this TokenErrorResponse.  # noqa: E501
        :type: str
        """
    ...
    def error_description(self):
        """Gets the error_description of this TokenErrorResponse.  # noqa: E501

        Gets the error description.  # noqa: E501

        :return: The error_description of this TokenErrorResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def error_description(self, error_description):
        """Sets the error_description of this TokenErrorResponse.

        Gets the error description.  # noqa: E501

        :param error_description: The error_description of this TokenErrorResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenErrorResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenErrorResponse):
            return False
