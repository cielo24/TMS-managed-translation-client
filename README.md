...
*FilesApi* | [**files_get_files**](docs/FilesApi.md#files_get_files) | **GET** /tm4lc/api/v1/files/{projectOptionsId} | Get Files
...
*FilesApi* | [**files_upload**](docs/FilesApi.md#files_upload) | **POST** /tm4lc/api/v1/files/{projectOptionsId} | Upload
...
## Documentation For Models
 ...
 - [FilesProjectOptionsIdBody](docs/FilesProjectOptionsIdBody.md)
 ...
 - [ProjectIdReferenceBody](docs/ProjectIdReferenceBody.md)
 - [ProjectMetadata](docs/ProjectMetadata.md)
 - [SearchMetadataOptions](docs/SearchMetadataOptions.md)
 - [StudiopackageUploadBody](docs/StudiopackageUploadBody.md)
