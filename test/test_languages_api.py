...
from swagger_client.api.languages_api import LanguagesApi  # noqa: E501
...
class TestLanguagesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.api.languages_api.LanguagesApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_languages_get_all_languages(self):
        """Test case for languages_get_all_languages
