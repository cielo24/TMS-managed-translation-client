...
class TestResourcesApi(unittest.TestCase):
    ...
    def test_resources_java_script_strings(self):
        """Test case for resources_java_script_strings

        Java Script Strings  # noqa: E501
        """
        pass

    def test_resources_ui_languages(self):
        """Test case for resources_ui_languages

        Ui Languages  # noqa: E501
        """
        pass

    def test_resources_version(self):
        """Test case for resources_version
